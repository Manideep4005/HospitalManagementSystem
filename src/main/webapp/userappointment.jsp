...
<title>Appointent Form | HMS</title>
...
<style>
    * {
        ...
        #signUpForm {
            ...
            margin: 30px auto;
            padding: 40px;
            box-shadow: 0px 6px 18px #01ffff;
            border-radius: 15px;
            transition: 0.34s ease-in-out;
        }

        #signUpForm:hover {
        	box-shadow: 0px 0px 0px 1px #01ffff;
        }
    ...
    /*position: fixed;
    width: 100%;*/
    border-bottom: 1.8px solid #38ff12;
}
  ...
  <ul>
    ...
    <li class="dropdown" style="float: right; margin-right: 1px;">
      ...
      <div class="dropdown-content">
        ...
        <a href="userdetails.jsp">My Account</a>
...
<h1>Book Appointment</h1>
    <form id="signUpForm" action="RegisterPatientServlet" method="post">
        ...
        <div class="form-header">
            ...
            <span class="stepIndicator">Chekup & Appointment Info</span>
          </div>
          <!-- end step indicators -->
        ...
        <div class="step">
            ...
            <div class="mb-15">
                <input type="text" placeholder="First name" oninput="this.className = ''" name="pfname" class="one">
            </div>
            <div class="mb-15">
                <input type="text" placeholder="Last name" oninput="this.className = ''" name="plname" class="one">
            </div>
            <div class="mb-15">
            ...
            <div class="mb-15">
                <input type="text" placeholder="Enter Age" oninput="this.className = ''" name="birth" class="one" id="age">
        ...
        <div class="step">
            ...
            <div class="mb-15">
                <textarea placeholder="Symptoms(400) Characters" name="symptoms" oninput="this.className = ''"  class="one"
                style="font-size: 18px; resize: none;" rows="1" cols="20"></textarea>
            </div>
            <div class="mb-15">
                <input type="date" required name="appointmentdate" value="yyyy/mm/dd" oninput="this.className = ''"  class="one">
            </div>
        </div>
