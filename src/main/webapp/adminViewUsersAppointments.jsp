...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
        ...
        Integer s = Integer.parseInt(request.getParameter("userid"));
    
         String name = "";

        PreparedStatement  pstmt1 = MySqlConnection.getConnection().prepareStatement("select username from user where userid = ?");
        pstmt1.setInt(1, s);
...
<title>User Appointments | <%= name %></title>
    ...
    <table>
      <!--    <tr>
        ...
        if (s == 0) {
            ...
            out.println("<h1>Appointments not found  (" + s + ")</h1>");
        }
        else {
            out.println("<h1>Appointments found user Id (" + s + ")</h1>");
            out.println("<tr>");
