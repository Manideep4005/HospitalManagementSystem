...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <% 
    	...
    	PreparedStatement pstmt = MySqlConnection.getConnection().prepareStatement("select * from user where userid = ? and username = ?");
    	pstmt.setInt(1, id);
...
<style type="text/css">
	* {
    ...
    /*position: fixed;
    width: 100%;*/
    border-bottom: 1.8px solid #FF005C;
}
    ...
    @media screen and (max-width:600px) {
      .column {
		...
		table {
			...
			margin-right: auto;
			margin-top: 1%;
			box-shadow: 0px 0px 10px 0px #809080;
			border-radius: 10px;
...
<div class="header">
  <p>My Account</p>
	...
	<div class="change_password">
		<p>To Change Password click on reset button</p>
		<a href="userChangePassword.jsp">Reset Password</a>
	</div>
