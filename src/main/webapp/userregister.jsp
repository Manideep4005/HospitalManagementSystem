...
<body>
  ...
  <ul>
    ...
    <li id="signin" style="float: right;"> 
    	<a class="dropbtn" href="Userlogin.html">
...
<div class="details_tab">
	<form method="post" onsubmit="return validateForm()" action="UserRegisterServlet">
		<div class="personal">
			<input type="text" name="userfname" placeholder="First Name..." id="name">
			<p id="demo1"></p>
			<input type="text" name="userlname" placeholder="Last Name..." id="lname">
			<p id="demo1"></p>
