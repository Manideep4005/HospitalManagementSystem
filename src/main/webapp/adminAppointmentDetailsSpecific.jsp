...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
    	...
    	PreparedStatement pstmt = MySqlConnection.getConnection().prepareStatement("select * from appointment where checkup_type=?");
    ...
    <li class="dropdown" style="float: right; margin-right: 1px;">
      ...
      <div class="dropdown-content">
        ...
        <a href="adminViewPatients.jsp">Patient List</a>
         <a href="adminAppointmentDetails.jsp">Appointments</a>
