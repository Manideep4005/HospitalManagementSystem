  ...
  <ul>
    ...
    <li class="dropdown" style="float: right; margin-right: 1px;">
      ...
      <div class="dropdown-content">
        ...
        <a href="adminmodule.jsp">Dashboard</a>
...
<div class="details">
    <h2>The login credentials for Dr. <%=session.getAttribute("doctorName") %></h2>
    <div class="inner-details">
        <p>Doctor Id: <%=session.getAttribute("doctorLoginId") %></p>
        <p>Password: <%=session.getAttribute("doctorPassword") %>  (Personal Email)</p>
    </div>
</div>

<div class="back">
    <form action="adminmodule.jsp" method="post">
        <button value="submit">Dashbaord</button>
    </form>
</div>
</body>
</html>