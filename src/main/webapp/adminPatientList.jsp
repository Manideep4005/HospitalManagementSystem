...
<li><a href="AdminProfileDetails">Update Profile</a></li>
              <li><a href="adminChangePassword.jsp">Change Password</a></li>
                    ...
                    <li><a href="adminViewPatients.jsp">Patient List</a></li>
          <li><a href="adminPatientsDepartmentView.jsp">Department Wise List</a></li>
...
<div class="div_1" onclick="navigate('AdminViewPatientsServlet')">
     All List
</div>

<div class="div_2" >
    <form method="post" action="AdminViewPatientsServlet">
