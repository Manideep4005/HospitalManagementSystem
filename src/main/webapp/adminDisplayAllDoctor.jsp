...
.scroll::-webkit-scrollbar-track {
  background: #f0f0f0; /* Change track color */
  border-radius: 10px;
}
...
<<<<<<< HEAD
    ...
    <div class="header-1-menu">
      ...
      <div class="sub-menu-2">
          <ul>
			<li><a href="doctorregister.jsp">Register Doctor</a></li>
          <li>
	...
	<div class="scroll">
		...
		<c:forEach items="${dlist}" var="d">
			...
			<div id="delete_doctor">
					...
					<button onclick="navigate('AdminDeleteDoctorServlet?doctorid=${d.doctorId}')">Delete</button>
	...
	<div class="scroll">
		<table>
			...
			while (itr.hasNext()) {
				...
				out.println("<td>" + dBean.getDoctorFirstName() + "</td>");
				out.println("<td>" + dBean.getDoctorLastName() + "</td>");
