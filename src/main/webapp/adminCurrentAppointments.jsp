...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
    	...
    	PreparedStatement stmt = MySqlConnection.getConnection().prepareStatement("select * from appointment where appointment_date=?");
    	stmt.setDate(1, date);
